...
from organization.views import OrganizationView, OrganizationHomeView, OrganizationCourseListView, OrganizationTeacherListView, OrganizationDescriptView, TeacherListView, TeacherDetailView
