...
class UserProfile(AbstractUser):
    ...
    email = models.EmailField(max_length=30, default="", verbose_name=u"邮箱")
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(verbose_name=u"验证码类型", choices=(("register", u"注册"),("forget", u"找回密码"),("reset_email",u"修改邮箱")) , max_length=15)
    ...
    def __str__(self):
         return "{0} {1} {2}".format(u"验证记录", self.email, self.code)
